...
export const metadata: Metadata = {
  ...
  description: "Assam CEE preparation platform — mock tests, previous year questions, analytics, and leaderboards.",
  keywords: ["Assam CEE", "CEE mock test", "CEE preparation", "JEC", "AEC", "physics chemistry maths"],
