...
export function MockTestCTA() {
  return (
    <section className="relative py-24 overflow-hidden bg-slate-900 dark:bg-slate-50">
      ...
      {/* Top Accent Line */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-16 bg-slate-700 dark:bg-slate-300" />
      ...
      <div className="container relative mx-auto px-4 md:px-6 text-center">
        ...
        >
          <Badge variant="secondary" className="mb-6 bg-slate-800 text-slate-300 hover:bg-slate-700 dark:bg-slate-200 dark:text-slate-700 dark:hover:bg-slate-300 border-none shadow-sm">
            <Timer className="w-3 h-3 mr-1" /> CEE 2026 Mock Test Portal
          </Badge>

          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white dark:text-slate-900 leading-[1.05]">
            Simulate the Exam. <br />
            <span className="text-slate-400 dark:text-slate-500">Secure Your Rank.</span>
          </h2>

          <p className="mt-5 text-lg md:text-xl text-slate-400 dark:text-slate-600 leading-relaxed max-w-2xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="h-12 px-8 bg-white text-slate-900 hover:bg-slate-100 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800 shadow-lg shadow-white/5 transition-all group"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-12 px-8 border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-white dark:border-slate-300 dark:text-slate-700 dark:hover:bg-slate-100 dark:hover:text-slate-900"
            >
      ...
      {/* Bottom Accent Line */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-16 bg-slate-700 dark:bg-slate-300" />
    </section>
  );
}